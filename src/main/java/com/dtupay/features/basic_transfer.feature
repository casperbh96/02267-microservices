Feature: Basic DTU Pay money transfer
  ...
  Scenario: Successful transfer
    ...
    And customer DTU Pay account "Bob Clark", CPR "220866-2859", and 1 unused token
    And merchant DTU Pay account "Alice Klaus", CVR "220866-2858"
  ...
  Scenario: Token is already used
    Given bank account "Bob Clark", "220866-2859" with start balance 1000
    And bank account "Alice Klaus", "220866-2858" with start balance 0
    And customer DTU Pay account "Bob Clark", CPR "220866-2859", and 1 used token
    And merchant DTU Pay account "Alice Klaus", CVR "220866-2858"
    When the merchant scans the customer's token
  ...
  Scenario: Token is invalid
    Given bank account "Bob Clark", "220866-2859" with start balance 1000
    And bank account "Alice Klaus", "220866-2858" with start balance 0
    And customer DTU Pay account "Bob Clark", CPR "220866-2859", and 1 invalid token
    And merchant DTU Pay account "Alice Klaus", CVR "220866-2858"
    When the merchant scans the customer's token
